        ...
        if (e.getButton() == MouseEvent.BUTTON1) // lewy przycisk
        {
            switch (GameStates.gameState) {
                ...
                case GAME_OVER:
                    ...
                    break;
                case YOU_WIN:
                    game.getYouWin().mouseClicked(e.getX(),e.getY());
                    break;
                default:
                    break;
            }
    ...
    public void mousePressed(MouseEvent e) {
        switch (GameStates.gameState) {
            ...
            case GAME_OVER:
                ...
                break;
            case YOU_WIN:
                game.getYouWin().mousePressed(e.getX(),e.getY());
                break;
            default:
                break;
        }
    ...
    public void mouseReleased(MouseEvent e) {
        switch (GameStates.gameState) {
            ...
            case GAME_OVER:
                ...
                break;
            case YOU_WIN:
                game.getYouWin().mouseReleased(e.getX(),e.getY());
                break;
            default:
                break;
        }
    ...
    public void mouseMoved(MouseEvent e) {
        switch (GameStates.gameState) {
            ...
            case GAME_OVER:
                ...
                break;
            case YOU_WIN:
                game.getYouWin().mouseMoved(e.getX(),e.getY());
                break;
            default:
                break;
        }
